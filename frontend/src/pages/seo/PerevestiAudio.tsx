...
export default function PerevestiAudio() {
  return (
    <SeoLanding
      ...
      metaTitle="Перевести аудио в текст онлайн — 180 минут бесплатно | Dicto"
      metaDescription="Перевод аудио в текст за 2 минуты на час записи. Точность 98% на русском и 12 других языках. Разметка спикеров, AI-саммари, экспорт TXT/SRT/DOCX. 180 минут бесплатно."
      ...
      relatedLinks={[
        ...
        },
        {
          ...
          desc: "Как получить 3 часа транскрибации без оплаты",
        },
        {
