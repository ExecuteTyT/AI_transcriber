...
export default function RusskijYazyk() {
  return (
    <SeoLanding
      ...
      metaDescription="Распознавание русской речи с точностью 98% — выше Yandex SpeechKit и Whisper. Сленг, термины, имена. AI-саммари. Бесплатная проба без карты."
      ...
      benefits={[
        ...
        "Бесплатная проба — 30 минут и AI-разбор, без карты, можно сразу проверить точность",
