...
export default function RaspoznavanieRechi() {
  return (
    <SeoLanding
      title="Попробуйте ASR бесплатно — 180 минут при регистрации"
      ...
      metaDescription="Распознавание речи с точностью 98% на русском. ASR-нейросеть Voxtral, 13 языков, разметка спикеров. Экспорт TXT/SRT/DOCX. 180 минут бесплатно без карты."
      ...
      steps={[
        {
          ...
          desc: "Поддерживаются MP3, WAV, FLAC, OGG, M4A, AAC, WebM, MP4, MOV. Лимит 500 МБ и 6 часов длительности. Работает также с публичными ссылками на YouTube, VK Video, Rutube, OK и Яндекс.Дзен — аудио скачивается автоматически. Предварительная обработка звука (нормализация уровня, шумоподавление) запускается автоматически.",
        },
        {
      ...
      benefits={[
        ...
        "180 минут бесплатно при регистрации — без карты и автоматических подписок",
      ]}
      faqs={[
        {
