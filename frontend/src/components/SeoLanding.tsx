...
export default function SeoLanding({
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <title>{metaTitle || h1 + " | Scribi"}</title>
      ...
      <section className="max-w-4xl mx-auto px-4 py-16">
        <h2 className="text-2xl font-bold text-center mb-10">Преимущества Scribi</h2>
      ...
      <footer className="border-t border-gray-200 py-8">
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-400">
          <div><span className="gradient-text font-bold">Scribi</span> &copy; 2026</div>
