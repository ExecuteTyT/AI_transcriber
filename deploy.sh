...
if [ ! -f .env ]; then
    ...
    sed -i "s|APP_URL=http://localhost:3000|APP_URL=https://dicto.pro|" .env
    sed -i "s|API_URL=http://localhost:8000|API_URL=https://dicto.pro|" .env
    echo ""
    echo "========================================="
...
echo "       -d dicto.pro --email YOUR_EMAIL --agree-tos"
echo ""
